...
CmlHiveAssist has two separate “streaming” layers:
...
When block streaming is enabled, CmlHiveAssist can **merge consecutive block chunks**
...
When draft streaming is active, CmlHiveAssist disables block streaming for that reply to avoid double-streaming.
