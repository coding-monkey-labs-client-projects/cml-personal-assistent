...
- CLI helpers: `cml-hive-assist onboard`, `cml-hive-assist models list`, `cml-hive-assist models set <provider/model>`.

## Built-in providers (pi-ai catalog)

CmlHiveAssist ships with the pi‑ai catalog. These providers require **no**
...
- CLI: `cml-hive-assist onboard --auth-choice token` (paste setup-token) or `cml-hive-assist models auth paste-token --provider anthropic`
...
- CLI: `cml-hive-assist onboard --auth-choice openai-codex` or `cml-hive-assist models auth login --provider openai-codex`
...
- Antigravity OAuth is shipped as a bundled plugin (`google-antigravity-auth`, disabled by default).
  - Enable: `cml-hive-assist plugins enable google-antigravity-auth`
  - Login: `cml-hive-assist models auth login --provider google-antigravity --set-default`
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  - Enable: `cml-hive-assist plugins enable google-gemini-cli-auth`
  - Login: `cml-hive-assist models auth login --provider google-gemini-cli --set-default`
  - Note: you do **not** paste a client id or secret into `cml-hive-assist.json`. The CLI login flow stores
...
- For custom providers, `reasoning`, `input`, `cost`, `contextWindow`, and `maxTokens` are optional.
  When omitted, CmlHiveAssist defaults to:
  - `reasoning: false`
  - `input: ["text"]`
  - `cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }`
  - `contextWindow: 200000`
