...
Deploy CML Hive Assist on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/cml-hive-assist` — Control UI

## What you get

- Hosted CML Hive Assist Gateway + Control UI
...
- `CML_HIVE_ASSIST_STATE_DIR=/data/.cml-hive-assist` (recommended)
- `CML_HIVE_ASSIST_WORKSPACE_DIR=/data/workspace` (recommended)
- `CML_HIVE_ASSIST_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your CML Hive Assist state + workspace so you can migrate to another host without losing config or memory.
