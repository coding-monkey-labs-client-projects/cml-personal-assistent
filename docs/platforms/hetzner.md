---
summary: "Run CmlHiveAssist Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want CmlHiveAssist running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running CmlHiveAssist in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# CmlHiveAssist on Hetzner (Docker, Production VPS Guide)

## Goal

Run a persistent CmlHiveAssist Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “CmlHiveAssist 24/7 for ~$5”, this is the simplest reliable setup.
...
2. Install Docker
3. Clone CmlHiveAssist repository
...
## 3) Clone the CmlHiveAssist repository
...
CML_HIVE_ASSIST_CONFIG_DIR=/root/.cml-hive-assist
CML_HIVE_ASSIST_WORKSPACE_DIR=/root/.cml-hive-assist/workspace
