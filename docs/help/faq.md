---
summary: "Frequently asked questions about CmlHiveAssist setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up CmlHiveAssist?](#whats-the-recommended-way-to-install-and-set-up-cml-hive-assist)
  ...
  - [I can't access docs.cml-hive-assist.ai (SSL error). What now?](#i-cant-access-docscml-hive-assistai-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or cml-hive-assist not recognized](#windows-install-says-git-not-found-or-cml-hive-assist-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install CmlHiveAssist on Linux?](#how-do-i-install-cml-hive-assist-on-linux)
  - [How do I install CmlHiveAssist on a VPS?](#how-do-i-install-cml-hive-assist-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask CmlHiveAssist to update itself?](#can-i-ask-cml-hive-assist-to-update-itself)
  ...
  - [If I buy a Mac mini to run CmlHiveAssist, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-cml-hive-assist-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different CmlHiveAssist instances?](#can-multiple-people-use-one-whatsapp-number-with-different-cml-hive-assist-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run CmlHiveAssist on a dedicated machine?](#how-important-is-it-to-run-cml-hive-assist-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run CmlHiveAssist in a VM and what are the requirements](#can-i-run-cml-hive-assist-in-a-vm-and-what-are-the-requirements)
- [What is CmlHiveAssist?](#what-is-cml-hive-assist)
  - [What is CmlHiveAssist, in one paragraph?](#what-is-cml-hive-assist-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for CmlHiveAssist](#what-are-the-top-five-everyday-use-cases-for-cml-hive-assist)
  - [Can CmlHiveAssist help with lead gen outreach ads and blogs for a SaaS](#can-cml-hive-assist-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can CmlHiveAssist run tasks on a schedule or continuously in the background?](#can-cml-hive-assist-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with CmlHiveAssist saved locally?](#is-all-data-used-with-cml-hive-assist-saved-locally)
  - [Where does CmlHiveAssist store its data?](#where-does-cml-hive-assist-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall CmlHiveAssist?](#how-do-i-completely-uninstall-cml-hive-assist)
...
- [Config basics](#config-basics)
  ...
  - [Can the CmlHiveAssist browser run headless?](#can-the-cml-hive-assist-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two CmlHiveAssist instances talk to each other (local + VPS)?](#can-two-cml-hive-assist-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does CmlHiveAssist load environment variables?](#how-does-cml-hive-assist-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of CmlHiveAssist instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-cml-hive-assist-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset CmlHiveAssist but keep it installed?](#how-do-i-completely-reset-cml-hive-assist-but-keep-it-installed)
  ...
  - [Why doesn’t CmlHiveAssist reply in a group?](#why-doesnt-cml-hive-assist-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do CmlHiveAssist, Flawd, and Krill use for models?](#what-do-cml-hive-assist-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `cml-hive-assist gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-cml-hive-assist-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `cml-hive-assist gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-cml-hive-assist-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run CmlHiveAssist in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-cml-hive-assist-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart CmlHiveAssist?](#i-closed-my-terminal-on-windows-how-do-i-restart-cml-hive-assist)
  ...
  - [ELI5: `cml-hive-assist gateway restart` vs `cml-hive-assist gateway`](#eli5-cml-hive-assist-gateway-restart-vs-cml-hive-assist-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose CmlHiveAssist to inbound DMs?](#is-it-safe-to-expose-cml-hive-assist-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/cml-hive-assist/cml-hive-assist-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   cml-hive-assist health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://cml-hive-assist.ai/install.sh | bash -s -- --install-method git
```

This installs CmlHiveAssist **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/cml-hive-assist/cml-hive-assist/issues
https://github.com/cml-hive-assist/cml-hive-assist/pulls
...
- `cml-hive-assist status`: quick snapshot of gateway/agent health + basic config.
- `cml-hive-assist models status`: checks provider auth + model availability.
- `cml-hive-assist doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `cml-hive-assist status --all`, `cml-hive-assist logs --follow`,
`cml-hive-assist gateway status`, `cml-hive-assist health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up CmlHiveAssist
...
If you don’t have a global install yet, run it via `pnpm cml-hive-assist onboard`.
...
- **Tailscale Serve** (recommended): keep bind loopback, run `cml-hive-assist gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `cml-hive-assist gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `cml-hive-assist dashboard`.
...
under `~/.cml-hive-assist/` (for example `~/.cml-hive-assist/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-cml-hive-assist-store-its-data),
...
https://github.com/cml-hive-assist/cml-hive-assist/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.cml-hive-assist.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.cml-hive-assist.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.cml-hive-assist.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docscml-hive-assistai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/cml-hive-assist/cml-hive-assist/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://cml-hive-assist.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://cml-hive-assist.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://cml-hive-assist.ai/install.ps1
...
```bash
curl -fsSL https://cml-hive-assist.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or cml-hive-assist not recognized
...
**2) cml-hive-assist is not recognized after install**
...
### How do I install CmlHiveAssist on Linux
...
### How do I install CmlHiveAssist on a VPS
...
### Can I ask CmlHiveAssist to update itself
...
cml-hive-assist update --tag <dist-tag|version>
...
```bash
cml-hive-assist update --yes --no-restart
cml-hive-assist gateway restart
```
...
`cml-hive-assist onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run CmlHiveAssist with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `cml-hive-assist models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `cml-hive-assist models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `cml-hive-assist models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. CmlHiveAssist no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so CmlHiveAssist can keep replying while a provider is rate‑limited.
...
CmlHiveAssist supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. CmlHiveAssist fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `cml-hive-assist.json`.

Steps:

1. Enable the plugin: `cml-hive-assist plugins enable google-gemini-cli-auth`
2. Login: `cml-hive-assist models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. CmlHiveAssist needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. CmlHiveAssist runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. CmlHiveAssist’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run CmlHiveAssist can I connect it to my MacBook Pro
...
- Use `cml-hive-assist nodes status` / `cml-hive-assist nodes list` to see it.
...
- DM your bot, then run `cml-hive-assist logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different CmlHiveAssist instances
...
If you run CmlHiveAssist via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the CmlHiveAssist code install. Your state
(`~/.cml-hive-assist`) and workspace (`~/.cml-hive-assist/workspace`) stay untouched.
...
**CmlHiveAssist-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run CmlHiveAssist on a dedicated machine
...
CmlHiveAssist is lightweight. For a basic Gateway + one chat channel:
...
### Can I run CmlHiveAssist in a VM and what are the requirements
...
## What is CmlHiveAssist?

### What is CmlHiveAssist in one paragraph

CmlHiveAssist is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

CmlHiveAssist is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for CmlHiveAssist
...
### Can CmlHiveAssist help with lead gen outreach ads and blogs for a SaaS
...
CmlHiveAssist draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

CmlHiveAssist is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use CmlHiveAssist when you
...
Showcase: https://cml-hive-assist.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.cml-hive-assist/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.cml-hive-assist/cml-hive-assist.json`). Precedence is `<workspace>/skills` > `~/.cml-hive-assist/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.cml-hive-assist/cml-hive-assist.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.cml-hive-assist/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which CmlHiveAssist treats as `<workspace>/skills`.
...
```bash
cml-hive-assist cron run <jobId> --force
cml-hive-assist cron runs --id <jobId> --limit 50
```
...
### Can CmlHiveAssist run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.cml-hive-assist.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-cml-hive-assist-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. CmlHiveAssist can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.cml-hive-assist/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: { "cml-hive-assist": { "os": ["darwin", "linux"], "requires": { "bins": ["imsg"] } } }
   ---
   ```
4. Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (CmlHiveAssist only needs stdio). See [iMessage](/channels/imessage).
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured CmlHiveAssist workspace); CmlHiveAssist treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.cml-hive-assist/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
CmlHiveAssist memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

CmlHiveAssist also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, CmlHiveAssist auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, CmlHiveAssist
prefers `local`.
...
### Is all data used with CmlHiveAssist saved locally

No - **CmlHiveAssist’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.cml-hive-assist` + your workspace directory).
...
Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.cml-hive-assist/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.cml-hive-assist`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.cml-hive-assist`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.cml-hive-assist/skills`).

Default workspace is `~/.cml-hive-assist/workspace`, configurable via:
...
Do **not** commit anything under `~/.cml-hive-assist` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall CmlHiveAssist
...
`workspace` to the repo root. The CmlHiveAssist repo is just source code; keep the
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `cml-hive-assist doctor --generate-gateway-token`.
...
key. **Recommended:** run `cml-hive-assist configure --section web` to store it in
...
- Daemons read env vars from `~/.cml-hive-assist/.env` (or the service environment).
...
### Can the CmlHiveAssist browser run headless
...
- Gateway is running: `cml-hive-assist gateway status`
- Gateway health: `cml-hive-assist status`
- Channel health: `cml-hive-assist channels status`
...
### Can two CmlHiveAssist instances talk to each other local VPS
...
`cml-hive-assist agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
cml-hive-assist agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.cml-hive-assist/cml-hive-assist.json`).
- If you have no backup, re-run `cml-hive-assist doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `cml-hive-assist config set` for small changes.
- Use `cml-hive-assist configure` for interactive edits.
...
### How does CmlHiveAssist load environment variables
...
1. Put the missing keys in `~/.cml-hive-assist/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`cml-hive-assist models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means CmlHiveAssist won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.cml-hive-assist/.env`:
   ```
...
### Is there a way to make a team of CmlHiveAssist instances one CEO and many agents
...
### How do I completely reset CmlHiveAssist but keep it installed
...
```bash
cml-hive-assist reset --scope full --yes --non-interactive
```
...
headers like `# Heading`), CmlHiveAssist skips the heartbeat run to save API calls.
...
No. CmlHiveAssist runs on **your own account**, so if you’re in the group, CmlHiveAssist can see it.
...
```bash
cml-hive-assist logs --follow --json
```
...
```bash
cml-hive-assist directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt CmlHiveAssist reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.cml-hive-assist/agents/<agentId>/sessions/`.
...
- Use `cml-hive-assist doctor` to spot stray workspaces and profile mismatches.
...
CmlHiveAssist’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, CmlHiveAssist currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `cml-hive-assist models set ...` (updates just model config)
- `cml-hive-assist configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.cml-hive-assist/cml-hive-assist.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `cml-hive-assist doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do CmlHiveAssist, Flawd, and Krill use for models

- **CmlHiveAssist + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. CmlHiveAssist ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `cml-hive-assist agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so CmlHiveAssist can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.cml-hive-assist/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.cml-hive-assist/agent/*` (migrated by `cml-hive-assist doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.cml-hive-assist/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `cml-hive-assist models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `cml-hive-assist models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `cml-hive-assist models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.cml-hive-assist/.env` on the **gateway host**.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), CmlHiveAssist will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: CmlHiveAssist now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
CmlHiveAssist uses provider‑prefixed IDs like:
...
CmlHiveAssist may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `cml-hive-assist models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
cml-hive-assist models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
cml-hive-assist models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

CmlHiveAssist supports both:
...
Use `cml-hive-assist gateway status` and trust these lines:
...
```bash
cml-hive-assist gateway install --force
```
...
CmlHiveAssist enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `cml-hive-assist gateway --port <port>`.

### How do I run CmlHiveAssist in remote mode client connects to a Gateway elsewhere
...
- `cml-hive-assist gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `cml-hive-assist.control.settings.v1`.
...
- Use `cml-hive-assist --profile <name> …` per instance (auto-creates `~/.cml-hive-assist-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `cml-hive-assist --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.cml-hive-assist.*`, `cml-hive-assist-gateway-<profile>.service`, `CmlHiveAssist Gateway (<profile>)`).
...
```
cml-hive-assist tui --url ws://<host>:18789 --token <token>
```
...
If you run the gateway manually, `cml-hive-assist gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart CmlHiveAssist
...
1. Is the Gateway running? `cml-hive-assist gateway status`
2. Is the Gateway healthy? `cml-hive-assist status`
3. Does the UI have the right token? `cml-hive-assist dashboard`
...
```bash
cml-hive-assist channels status
cml-hive-assist channels logs --channel telegram
```
...
### ELI5 cml-hive-assist gateway restart vs cml-hive-assist gateway

- `cml-hive-assist gateway restart`: restarts the **background service** (launchd/systemd).
- `cml-hive-assist gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `cml-hive-assist gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [CmlHiveAssist assistant setup](/start/cml-hive-assist) and [Agent send](/tools/agent-send).

CLI sending:

```bash
cml-hive-assist message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose CmlHiveAssist to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `cml-hive-assist pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `cml-hive-assist pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `cml-hive-assist doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. CmlHiveAssist only replies to chats it receives or to explicit sends you trigger.
...
```bash
cml-hive-assist pairing list whatsapp
```
...
CmlHiveAssist blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In CmlHiveAssist, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/cml-hive-assist/cml-hive-assist/discussions).
