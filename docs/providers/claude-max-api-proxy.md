...
You can point CmlHiveAssist at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or CmlHiveAssist
...
- [Anthropic provider](/providers/anthropic) - Native CmlHiveAssist integration with Claude setup-token or API keys
