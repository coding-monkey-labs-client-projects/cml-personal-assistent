---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with CmlHiveAssist"
read_when:
  - You want Xiaomi MiMo models in CmlHiveAssist
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). CmlHiveAssist uses
