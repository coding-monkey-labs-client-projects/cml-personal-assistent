---
summary: "Use Qwen OAuth (free tier) in CmlHiveAssist"
read_when:
  - You want to use Qwen with CmlHiveAssist
...
If you already logged in with the Qwen Code CLI, CmlHiveAssist will sync credentials
