...
read_when:
  - You want CmlHiveAssist to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables CmlHiveAssist to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`cml-hive-assist onboard`) and `cml-hive-assist channels add` list optional channel plugins.
