...
Tlon is a decentralized messenger built on Urbit. CmlHiveAssist connects to your Urbit ship and can
...
Use these with `cml-hive-assist message send` or cron delivery:
...
- Thread replies: if the inbound message is in a thread, CmlHiveAssist replies in-thread.
