...
- Install via CLI: `cml-hive-assist plugins install @cml-hive-assist/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `cml-hive-assist plugins install ./extensions/zalo`
   - From npm (if published): `cml-hive-assist plugins install @cml-hive-assist/zalo`
...
- Approve via:
  - `cml-hive-assist pairing list zalo`
  - `cml-hive-assist pairing approve zalo <CODE>`
...
- Example: `cml-hive-assist message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `cml-hive-assist channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `cml-hive-assist logs --follow`
