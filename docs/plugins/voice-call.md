...
read_when:
  - You want to place an outbound voice call from CmlHiveAssist
...
Voice calls for CmlHiveAssist via a plugin. Supports outbound notifications and
...
- Use `cml-hive-assist voicecall ...` or the `voice_call` tool
