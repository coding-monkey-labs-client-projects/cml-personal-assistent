...
read_when:
  - You are building a CmlHiveAssist plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (cml-hive-assist.plugin.json)

Every plugin **must** ship a `cml-hive-assist.plugin.json` file in the **plugin root**.
CmlHiveAssist uses this manifest to validate configuration **without executing plugin
