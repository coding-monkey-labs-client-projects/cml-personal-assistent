...
summary: Machine-checked security models for CmlHiveAssist’s highest-risk paths.
permalink: /security/formal-verification/
---

# Formal Verification (Security Models)

This page tracks CmlHiveAssist’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that CmlHiveAssist enforces its
...
**What this is not (yet):** a proof that “CmlHiveAssist is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/cml-hive-assist-formal-models](https://github.com/vignesh07/cml-hive-assist-formal-models).
