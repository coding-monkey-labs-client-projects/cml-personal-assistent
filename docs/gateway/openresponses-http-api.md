...
CmlHiveAssist’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`cml-hive-assist agent`), so routing/permissions/config match your Gateway.
