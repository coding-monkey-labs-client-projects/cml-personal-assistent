...
CmlHiveAssist ships three update channels:
...
When you **explicitly** switch channels with `--channel`, CmlHiveAssist also aligns
the install method:
...
When you switch channels with `cml-hive-assist update`, CmlHiveAssist also syncs plugin sources:
