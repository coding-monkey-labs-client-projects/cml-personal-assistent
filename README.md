# 🦞 CmlHiveAssist — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/cml-hive-assist/cml-hive-assist/main/docs/assets/cml-hive-assist-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/cml-hive-assist/cml-hive-assist/main/docs/assets/cml-hive-assist-logo-text.png" alt="CmlHiveAssist" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/cml-hive-assist/cml-hive-assist/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/cml-hive-assist/cml-hive-assist/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/cml-hive-assist/cml-hive-assist/releases"><img src="https://img.shields.io/github/v/release/cml-hive-assist/cml-hive-assist?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**CmlHiveAssist** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://cml-hive-assist.ai) · [Docs](https://docs.cml-hive-assist.ai) · [DeepWiki](https://deepwiki.com/cml-hive-assist/cml-hive-assist) · [Getting Started](https://docs.cml-hive-assist.ai/start/getting-started) · [Updating](https://docs.cml-hive-assist.ai/install/updating) · [Showcase](https://docs.cml-hive-assist.ai/start/showcase) · [FAQ](https://docs.cml-hive-assist.ai/start/faq) · [Wizard](https://docs.cml-hive-assist.ai/start/wizard) · [Nix](https://github.com/cml-hive-assist/nix-clawdbot) · [Docker](https://docs.cml-hive-assist.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`cml-hive-assist onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.cml-hive-assist.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.cml-hive-assist.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.cml-hive-assist.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.cml-hive-assist.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.cml-hive-assist.ai/start/getting-started)
...
# Send a message
cml-hive-assist message send --to +1234567890 --message "Hello from CmlHiveAssist"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
cml-hive-assist agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.cml-hive-assist.ai/install/updating) (and run `cml-hive-assist doctor`).
...
Switch channels (git + npm): `cml-hive-assist update --channel stable|beta|dev`.
Details: [Development channels](https://docs.cml-hive-assist.ai/install/development-channels).
...
pnpm cml-hive-assist onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm cml-hive-assist ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `cml-hive-assist` binary.

## Security defaults (DM access)

CmlHiveAssist connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.cml-hive-assist.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `cml-hive-assist pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `cml-hive-assist doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.cml-hive-assist.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.cml-hive-assist.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.cml-hive-assist.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.cml-hive-assist.ai/nodes/voicewake) + [Talk Mode](https://docs.cml-hive-assist.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.cml-hive-assist.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.cml-hive-assist.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.cml-hive-assist.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.cml-hive-assist.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.cml-hive-assist.ai/nodes).
- **[Onboarding](https://docs.cml-hive-assist.ai/start/wizard) + [skills](https://docs.cml-hive-assist.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=cml-hive-assist/cml-hive-assist&type=date&legend=top-left)](https://www.star-history.com/#cml-hive-assist/cml-hive-assist&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.cml-hive-assist.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.cml-hive-assist.ai/web), and [Canvas host](https://docs.cml-hive-assist.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.cml-hive-assist.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.cml-hive-assist.ai/start/wizard), and [doctor](https://docs.cml-hive-assist.ai/gateway/doctor).
- [Pi agent runtime](https://docs.cml-hive-assist.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.cml-hive-assist.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.cml-hive-assist.ai/concepts/groups).
- [Media pipeline](https://docs.cml-hive-assist.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.cml-hive-assist.ai/nodes/audio).

### Channels

- [Channels](https://docs.cml-hive-assist.ai/channels): [WhatsApp](https://docs.cml-hive-assist.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.cml-hive-assist.ai/channels/telegram) (grammY), [Slack](https://docs.cml-hive-assist.ai/channels/slack) (Bolt), [Discord](https://docs.cml-hive-assist.ai/channels/discord) (discord.js), [Google Chat](https://docs.cml-hive-assist.ai/channels/googlechat) (Chat API), [Signal](https://docs.cml-hive-assist.ai/channels/signal) (signal-cli), [iMessage](https://docs.cml-hive-assist.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.cml-hive-assist.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.cml-hive-assist.ai/channels/msteams) (extension), [Matrix](https://docs.cml-hive-assist.ai/channels/matrix) (extension), [Zalo](https://docs.cml-hive-assist.ai/channels/zalo) (extension), [Zalo Personal](https://docs.cml-hive-assist.ai/channels/zalouser) (extension), [WebChat](https://docs.cml-hive-assist.ai/web/webchat).
- [Group routing](https://docs.cml-hive-assist.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.cml-hive-assist.ai/channels).

### Apps + nodes

- [macOS app](https://docs.cml-hive-assist.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.cml-hive-assist.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.cml-hive-assist.ai/nodes/talk) overlay, [WebChat](https://docs.cml-hive-assist.ai/web/webchat), debug tools, [remote gateway](https://docs.cml-hive-assist.ai/gateway/remote) control.
- [iOS node](https://docs.cml-hive-assist.ai/platforms/ios): [Canvas](https://docs.cml-hive-assist.ai/platforms/mac/canvas), [Voice Wake](https://docs.cml-hive-assist.ai/nodes/voicewake), [Talk Mode](https://docs.cml-hive-assist.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.cml-hive-assist.ai/platforms/android): [Canvas](https://docs.cml-hive-assist.ai/platforms/mac/canvas), [Talk Mode](https://docs.cml-hive-assist.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.cml-hive-assist.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.cml-hive-assist.ai/tools/browser): dedicated cml-hive-assist Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.cml-hive-assist.ai/platforms/mac/canvas): [A2UI](https://docs.cml-hive-assist.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.cml-hive-assist.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.cml-hive-assist.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.cml-hive-assist.ai/automation/cron-jobs); [webhooks](https://docs.cml-hive-assist.ai/automation/webhook); [Gmail Pub/Sub](https://docs.cml-hive-assist.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.cml-hive-assist.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.cml-hive-assist.ai/concepts/channel-routing), [retry policy](https://docs.cml-hive-assist.ai/concepts/retry), and [streaming/chunking](https://docs.cml-hive-assist.ai/concepts/streaming).
- [Presence](https://docs.cml-hive-assist.ai/concepts/presence), [typing indicators](https://docs.cml-hive-assist.ai/concepts/typing-indicators), and [usage tracking](https://docs.cml-hive-assist.ai/concepts/usage-tracking).
- [Models](https://docs.cml-hive-assist.ai/concepts/models), [model failover](https://docs.cml-hive-assist.ai/concepts/model-failover), and [session pruning](https://docs.cml-hive-assist.ai/concepts/session-pruning).
- [Security](https://docs.cml-hive-assist.ai/gateway/security) and [troubleshooting](https://docs.cml-hive-assist.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.cml-hive-assist.ai/web) + [WebChat](https://docs.cml-hive-assist.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.cml-hive-assist.ai/gateway/tailscale) or [SSH tunnels](https://docs.cml-hive-assist.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.cml-hive-assist.ai/install/nix) for declarative config; [Docker](https://docs.cml-hive-assist.ai/install/docker)-based installs.
- [Doctor](https://docs.cml-hive-assist.ai/gateway/doctor) migrations, [logging](https://docs.cml-hive-assist.ai/logging).
...
- **[Gateway WebSocket network](https://docs.cml-hive-assist.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.cml-hive-assist.ai/gateway)).
- **[Tailscale exposure](https://docs.cml-hive-assist.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.cml-hive-assist.ai/gateway/remote)).
- **[Browser control](https://docs.cml-hive-assist.ai/tools/browser)** — cml-hive-assist‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.cml-hive-assist.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.cml-hive-assist.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.cml-hive-assist.ai/nodes/voicewake) + [Talk Mode](https://docs.cml-hive-assist.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.cml-hive-assist.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

CmlHiveAssist can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (CmlHiveAssist enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.cml-hive-assist.ai/gateway/tailscale) · [Web surfaces](https://docs.cml-hive-assist.ai/web)
...
Details: [Remote access](https://docs.cml-hive-assist.ai/gateway/remote) · [Nodes](https://docs.cml-hive-assist.ai/nodes) · [Security](https://docs.cml-hive-assist.ai/gateway/security)
...
Details: [Nodes](https://docs.cml-hive-assist.ai/nodes) · [macOS app](https://docs.cml-hive-assist.ai/platforms/macos) · [Gateway protocol](https://docs.cml-hive-assist.ai/concepts/architecture)
...
Details: [Session tools](https://docs.cml-hive-assist.ai/concepts/session-tool)
...
### macOS (CmlHiveAssist.app) (optional)
...
- Controlled via `cml-hive-assist nodes …`.

Runbook: [iOS connect](https://docs.cml-hive-assist.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.cml-hive-assist.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.cml-hive-assist/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.cml-hive-assist/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.cml-hive-assist/cml-hive-assist.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.cml-hive-assist.ai/gateway/configuration)
...
Details: [Security guide](https://docs.cml-hive-assist.ai/gateway/security) · [Docker + sandboxing](https://docs.cml-hive-assist.ai/install/docker) · [Sandbox config](https://docs.cml-hive-assist.ai/gateway/configuration)

### [WhatsApp](https://docs.cml-hive-assist.ai/channels/whatsapp)

- Link the device: `pnpm cml-hive-assist channels login` (stores creds in `~/.cml-hive-assist/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.cml-hive-assist.ai/channels/telegram)
...
### [Slack](https://docs.cml-hive-assist.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.cml-hive-assist.ai/channels/discord)
...
### [Signal](https://docs.cml-hive-assist.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.cml-hive-assist.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.cml-hive-assist.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.cml-hive-assist.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.cml-hive-assist.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.cml-hive-assist.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.cml-hive-assist.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.cml-hive-assist.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.cml-hive-assist.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.cml-hive-assist.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.cml-hive-assist.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.cml-hive-assist.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.cml-hive-assist.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.cml-hive-assist.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.cml-hive-assist.ai/platforms/windows), [Linux](https://docs.cml-hive-assist.ai/platforms/linux), [macOS](https://docs.cml-hive-assist.ai/platforms/macos), [iOS](https://docs.cml-hive-assist.ai/platforms/ios), [Android](https://docs.cml-hive-assist.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.cml-hive-assist.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.cml-hive-assist.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.cml-hive-assist.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.cml-hive-assist.ai/gateway/bonjour)
- [Gateway pairing](https://docs.cml-hive-assist.ai/gateway/pairing)
- [Remote gateway README](https://docs.cml-hive-assist.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.cml-hive-assist.ai/web/control-ui)
- [Dashboard](https://docs.cml-hive-assist.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.cml-hive-assist.ai/gateway/health)
- [Gateway lock](https://docs.cml-hive-assist.ai/gateway/gateway-lock)
- [Background process](https://docs.cml-hive-assist.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.cml-hive-assist.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.cml-hive-assist.ai/logging)

## Deep dives

- [Agent loop](https://docs.cml-hive-assist.ai/concepts/agent-loop)
- [Presence](https://docs.cml-hive-assist.ai/concepts/presence)
- [TypeBox schemas](https://docs.cml-hive-assist.ai/concepts/typebox)
- [RPC adapters](https://docs.cml-hive-assist.ai/reference/rpc)
- [Queue](https://docs.cml-hive-assist.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.cml-hive-assist.ai/tools/skills-config)
- [Default AGENTS](https://docs.cml-hive-assist.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.cml-hive-assist.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.cml-hive-assist.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.cml-hive-assist.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.cml-hive-assist.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.cml-hive-assist.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.cml-hive-assist.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.cml-hive-assist.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.cml-hive-assist.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.cml-hive-assist.ai/platforms/mac/voicewake)
- [iOS node](https://docs.cml-hive-assist.ai/platforms/ios)
- [Android node](https://docs.cml-hive-assist.ai/platforms/android)
- [Windows (WSL2)](https://docs.cml-hive-assist.ai/platforms/windows)
- [Linux app](https://docs.cml-hive-assist.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.cml-hive-assist.ai/gmail-pubsub](https://docs.cml-hive-assist.ai/automation/gmail-pubsub)

## Molty

CmlHiveAssist was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [cml-hive-assist.ai](https://cml-hive-assist.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@cml-hive-assist](https://x.com/cml-hive-assist)
