...
declare global {
  interface Window {
    __CML_HIVE_ASSIST_ASSISTANT_NAME__?: string;
    __CML_HIVE_ASSIST_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__CML_HIVE_ASSIST_ASSISTANT_NAME__,
    avatar: window.__CML_HIVE_ASSIST_ASSISTANT_AVATAR__,
  });
}
