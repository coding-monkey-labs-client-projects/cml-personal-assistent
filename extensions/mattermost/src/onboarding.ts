import type { ChannelOnboardingAdapter, CmlHiveAssistConfig, WizardPrompter } from "openclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.cml-hive-assist.ai/channels/mattermost",
    ].join("\n"),
...
export const mattermostOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  disable: (cfg: CmlHiveAssistConfig) => ({
    ...cfg,
    channels: {
      ...cfg.channels,
