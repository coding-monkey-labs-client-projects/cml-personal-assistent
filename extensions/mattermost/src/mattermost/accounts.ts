...
export function listMattermostAccountIds(cfg: CmlHiveAssistConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: CmlHiveAssistConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CmlHiveAssistConfig): ResolvedMattermostAccount[] {
