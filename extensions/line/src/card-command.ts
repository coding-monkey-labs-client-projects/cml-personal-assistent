import type { LineChannelData, CmlHiveAssistPluginApi, ReplyPayload } from "openclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: CmlHiveAssistPluginApi): void {
  api.registerCommand({
    name: "card",
