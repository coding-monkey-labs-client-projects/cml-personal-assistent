...
export function listZaloAccountIds(cfg: CmlHiveAssistConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: CmlHiveAssistConfig): string {
...
function mergeZaloAccountConfig(cfg: CmlHiveAssistConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: CmlHiveAssistConfig): ResolvedZaloAccount[] {
