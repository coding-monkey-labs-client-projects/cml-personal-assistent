...
export function listGoogleChatAccountIds(cfg: CmlHiveAssistConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: CmlHiveAssistConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: CmlHiveAssistConfig): ResolvedGoogleChatAccount[] {
