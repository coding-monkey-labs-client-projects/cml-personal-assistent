...
export function listZalouserAccountIds(cfg: CmlHiveAssistConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: CmlHiveAssistConfig): string {
...
function mergeZalouserAccountConfig(cfg: CmlHiveAssistConfig, accountId: string): ZalouserAccountConfig {
