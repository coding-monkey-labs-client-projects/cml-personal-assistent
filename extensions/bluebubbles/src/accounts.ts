...
export function listBlueBubblesAccountIds(cfg: CmlHiveAssistConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: CmlHiveAssistConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: CmlHiveAssistConfig): ResolvedBlueBubblesAccount[] {
