...
// NOTE: This extension is intended to be bundled with CmlHiveAssist.
// When running from source (tests/dev), CmlHiveAssist internals live under src/.
...
export function createLlmTaskTool(api: CmlHiveAssistPluginApi) {
  return {
    name: "llm-task",
    description:
      "Run a generic JSON-only LLM task and return schema-validated JSON. Designed for orchestration from Lobster workflows via cml-hive-assist.invoke.",
