...
function setMSTeamsDmPolicy(cfg: CmlHiveAssistConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: CmlHiveAssistConfig, allowFrom: string[]): CmlHiveAssistConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
