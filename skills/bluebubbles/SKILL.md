---
name: bluebubbles
description: Build or update the BlueBubbles external channel plugin for CmlHiveAssist (extension package, REST send/probe, webhook inbound).
---
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `cml-hive-assist/plugin-sdk` helpers.
