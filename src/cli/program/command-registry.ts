...
import { agentsListCommand } from "../../commands/agents.ts";
import { healthCommand } from "../../commands/health.ts";
import { sessionsCommand } from "../../commands/sessions.ts";
import { statusCommand } from "../../commands/status.ts";
import { defaultRuntime } from "../../runtime.ts";
import { getFlagValue, getPositiveIntFlagValue, getVerboseFlag, hasFlag } from "../argv.ts";
import { registerBrowserCli } from "../browser-cli.ts";
import { registerConfigCli } from "../config-cli.ts";
import { registerMemoryCli, runMemoryStatus } from "../memory-cli.ts";
import { registerAgentCommands } from "./register.agent.ts";
import { registerConfigureCommand } from "./register.configure.ts";
import { registerMaintenanceCommands } from "./register.maintenance.ts";
import { registerMessageCommands } from "./register.message.ts";
import { registerOnboardCommand } from "./register.onboard.ts";
import { registerSetupCommand } from "./register.setup.ts";
import { registerStatusHealthSessionsCommands } from "./register.status-health-sessions.ts";
