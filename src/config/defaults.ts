...
import { resolveTalkApiKey } from "./talk.ts";
...
export function applyMessageDefaults(cfg: CmlHiveAssistConfig): CmlHiveAssistConfig {
...
export function applyTalkApiKey(config: CmlHiveAssistConfig): CmlHiveAssistConfig {
...
export function applyModelDefaults(cfg: CmlHiveAssistConfig): CmlHiveAssistConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CmlHiveAssistConfig): CmlHiveAssistConfig {
...
export function applyLoggingDefaults(cfg: CmlHiveAssistConfig): CmlHiveAssistConfig {
...
export function applyContextPruningDefaults(cfg: CmlHiveAssistConfig): CmlHiveAssistConfig {
...
export function applyCompactionDefaults(cfg: CmlHiveAssistConfig): CmlHiveAssistConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
