export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "cml-hive-assist-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "cml-hive-assist-macos",
  IOS_APP: "cml-hive-assist-ios",
  ANDROID_APP: "cml-hive-assist-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "cml-hive-assist-probe",
} as const;
