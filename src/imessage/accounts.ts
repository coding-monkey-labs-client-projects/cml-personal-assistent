...
import type { IMessageAccountConfig } from "../config/types.ts";
...
export function listIMessageAccountIds(cfg: CmlHiveAssistConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: CmlHiveAssistConfig): string {
...
function mergeIMessageAccountConfig(cfg: CmlHiveAssistConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: CmlHiveAssistConfig): ResolvedIMessageAccount[] {
