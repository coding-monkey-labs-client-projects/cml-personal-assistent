...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CmlHiveAssistConfig): boolean {
...
export function summarizeBindings(cfg: CmlHiveAssistConfig, bindings: AgentBinding[]): string[] {
