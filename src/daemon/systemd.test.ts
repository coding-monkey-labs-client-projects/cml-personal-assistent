...
describe("resolveSystemdUserUnitPath", () => {
  ...
  it("prefers CML_HIVE_ASSIST_SYSTEMD_UNIT over CML_HIVE_ASSIST_PROFILE", () => {
    const env = {
      HOME: "/home/test",
      CML_HIVE_ASSIST_PROFILE: "jbphoenix",
      CML_HIVE_ASSIST_SYSTEMD_UNIT: "custom-unit",
    };
    expect(resolveSystemdUserUnitPath(env)).toBe(
  ...
  it("handles CML_HIVE_ASSIST_SYSTEMD_UNIT with .service suffix", () => {
    const env = {
      HOME: "/home/test",
      CML_HIVE_ASSIST_SYSTEMD_UNIT: "custom-unit.service",
    };
    expect(resolveSystemdUserUnitPath(env)).toBe(
      "/home/test/.config/systemd/user/custom-unit.service",
    );
  ...
  it("trims whitespace from CML_HIVE_ASSIST_SYSTEMD_UNIT", () => {
    const env = {
      HOME: "/home/test",
      CML_HIVE_ASSIST_SYSTEMD_UNIT: "  custom-unit  ",
    };
