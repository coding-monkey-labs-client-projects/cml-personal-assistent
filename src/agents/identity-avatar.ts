...
function resolveAvatarSource(cfg: CmlHiveAssistConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CmlHiveAssistConfig, agentId: string): AgentAvatarResolution {
