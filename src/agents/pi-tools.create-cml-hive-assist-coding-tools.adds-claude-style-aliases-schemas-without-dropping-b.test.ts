...
describe("createCmlHiveAssistCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    const config: CmlHiveAssistConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createCmlHiveAssistCodingTools({
      config,
    ...
    const anthropicTools = createCmlHiveAssistCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createCmlHiveAssistCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createCmlHiveAssistCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
