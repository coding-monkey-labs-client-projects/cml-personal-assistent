import type { CmlHiveAssistConfig, HumanDelayConfig, IdentityConfig } from "../config/config.ts";
...
export function resolveAckReaction(cfg: CmlHiveAssistConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: CmlHiveAssistConfig, agentId: string): string | undefined {
