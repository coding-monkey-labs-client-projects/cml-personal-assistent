...
import type { CmlHiveAssistConfig, SkillConfig } from "../../config/config.ts";
...
export function resolveConfigPath(config: CmlHiveAssistConfig | undefined, pathStr: string) {
...
export function resolveBundledAllowlist(config?: CmlHiveAssistConfig): string[] | undefined {
