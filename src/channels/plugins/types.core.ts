...
import type { NormalizedChatType } from "../chat-type.ts";
import type { ChatChannelId } from "../registry.ts";
...
export type ChannelAgentToolFactory = (params: { cfg?: CmlHiveAssistConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: CmlHiveAssistConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: CmlHiveAssistConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: CmlHiveAssistConfig }) => boolean;
  supportsCards?: (params: { cfg: CmlHiveAssistConfig }) => boolean;
