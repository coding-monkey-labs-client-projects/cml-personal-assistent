...
export const A2UI_PATH = "/__cml_hive_assist__/a2ui";

export const CANVAS_HOST_PATH = "/__cml_hive_assist__/canvas";

export const CANVAS_WS_PATH = "/__cml_hive_assist__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.cmlHiveAssistCanvasA2UIAction.postMessage(...)
  // - Android: window.cmlHiveAssistCanvasA2UIAction.postMessage(...)
  const handlerNames = ["cmlHiveAssistCanvasA2UIAction"];
  ...
  globalThis.cmlHiveAssistPostMessage = postToNode;
  globalThis.cmlHiveAssistSendUserAction = sendUserAction;
