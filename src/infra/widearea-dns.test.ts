...
describe("wide-area DNS-SD zone rendering", () => {
  it("renders a zone with gateway PTR/SRV/TXT records", () => {
    ...
    expect(txt).toContain(`_cml-hive-assist-gw._tcp IN PTR studio-london._cml-hive-assist-gw._tcp`);
    expect(txt).toContain(`studio-london._cml-hive-assist-gw._tcp IN SRV 0 0 18789 studio-london`);
    ...
    expect(txt).toContain(`cliPath=/opt/homebrew/bin/cml-hive-assist`);
  });
