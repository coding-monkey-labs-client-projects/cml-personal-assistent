...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = CmlHiveAssistChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = CmlHiveAssistChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
