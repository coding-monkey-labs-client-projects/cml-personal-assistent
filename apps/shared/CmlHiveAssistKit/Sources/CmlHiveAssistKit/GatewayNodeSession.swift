...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.cml-hive-assist", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.cml-hive-assist", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: CmlHiveAssistProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
