...
public enum CmlHiveAssistCanvasA2UICommand: String, Codable, Sendable {
...
public struct CmlHiveAssistCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CmlHiveAssistCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
