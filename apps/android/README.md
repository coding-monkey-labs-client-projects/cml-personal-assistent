## CmlHiveAssist Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_cml-hive-assist-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm cml-hive-assist gateway --port 18789 --verbose
```
