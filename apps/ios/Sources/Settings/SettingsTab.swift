...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = CmlHiveAssistLocationMode.off.rawValue
        ...
        NavigationStack {
            Form {
                ...
                Section("Screen") {
                    ...
                    Text("Keeps the screen awake while CmlHiveAssist is open.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    private var locationMode: CmlHiveAssistLocationMode {
        CmlHiveAssistLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
