...
actor CameraController {
    ...
    func snap(params: CmlHiveAssistCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: CmlHiveAssistCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("cml-hive-assist-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("cml-hive-assist-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: CmlHiveAssistCameraFacing,
