...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: CmlHiveAssistLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: CmlHiveAssistLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: CmlHiveAssistLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
