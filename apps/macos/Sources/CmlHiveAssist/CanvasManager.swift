...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.cml-hive-assist", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("CmlHiveAssist/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__cml-hive-assist__/a2ui/").absoluteString + "?platform=macos"
    }
