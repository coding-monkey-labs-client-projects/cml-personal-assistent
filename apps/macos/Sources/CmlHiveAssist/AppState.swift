...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = CmlHiveAssistConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = CmlHiveAssistConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = CmlHiveAssistConfigFile.loadDict()
            ...
            CmlHiveAssistConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/cml-hive-assist"
        state.remoteCliPath = ""
        return state
    }
}
