...
extension OnboardingView {
    static func exerciseForTesting() {
        ...
        let gateway = GatewayDiscoveryModel.DiscoveredGateway(
            ...
            sshPort: 2222,
            gatewayPort: 18789,
            cliPath: "/usr/local/bin/cml-hive-assist",
            stableID: "gateway-1",
            debugID: "gateway-1",
            isLocal: false)
        ...
        view.localGatewayProbe = LocalGatewayProbe(
            ...
            pid: 123,
            command: "cml-hive-assist-gateway",
            expected: true)
        view.showAdvancedConnection = true
        view.preferredGatewayID = gateway.stableID
        view.cliInstalled = true
        view.cliInstallLocation = "/usr/local/bin/cml-hive-assist"
        view.cliStatus = "Installed"
        view.workspacePath = "/tmp/cml-hive-assist"
