...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: CmlHiveAssistProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": CmlHiveAssistProtocol.AnyCodable("start"),
                "name": CmlHiveAssistProtocol.AnyCodable("bash"),
            ],
            summary: nil)
