...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.cml-hive-assist", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other CmlHiveAssist windows, but below the system’s pop-up menus.
