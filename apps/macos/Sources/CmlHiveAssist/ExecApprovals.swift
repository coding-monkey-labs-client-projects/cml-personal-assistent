...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.cml-hive-assist", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        CmlHiveAssistPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        CmlHiveAssistPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
