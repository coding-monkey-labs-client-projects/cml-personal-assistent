...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.cml-hive-assist", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.cml-hive-assist", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [CmlHiveAssistChatMessage] = messages.compactMap { item in
