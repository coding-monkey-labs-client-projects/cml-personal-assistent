...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .cml-hive-assistSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? CmlHiveAssistPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? CmlHiveAssistPaths.stateDirURL.path
...
extension Notification.Name {
    static let cml-hive-assistSelectSettingsTab = Notification.Name("cml-hive-assistSelectSettingsTab")
}
