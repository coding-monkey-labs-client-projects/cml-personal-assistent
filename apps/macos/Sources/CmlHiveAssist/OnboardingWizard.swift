...
private let onboardingWizardLogger = Logger(subsystem: "ai.cml-hive-assist", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between CmlHiveAssistProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = CmlHiveAssistProtocol.AnyCodable
