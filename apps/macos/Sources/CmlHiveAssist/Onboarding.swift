...
enum UIStrings {
    static let welcomeTitle = "Welcome to CmlHiveAssist"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "cml-hive-assist.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: CmlHiveAssistOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: CmlHiveAssistChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g cml-hive-assist@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: CmlHiveAssistChatViewModel(
