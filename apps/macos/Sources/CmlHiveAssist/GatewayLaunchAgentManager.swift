...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.cml-hive-assist", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".cml-hive-assist/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.cml-hive-assistCommand(
            subcommand: "gateway",
