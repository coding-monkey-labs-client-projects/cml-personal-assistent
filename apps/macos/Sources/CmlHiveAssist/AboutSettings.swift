...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/cml-hive-assist/cml-hive-assist") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/cml-hive-assist/cml-hive-assist")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://cml-hive-assist.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "CmlHiveAssistBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "CmlHiveAssistBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "CmlHiveAssistGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CmlHiveAssistGitCommit") as? String) ??
            "unknown"
    }
