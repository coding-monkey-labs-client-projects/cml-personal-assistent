...
/// Menu contents for the CmlHiveAssist menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About CmlHiveAssist") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "CmlHiveAssist Not Configured"
        case .remote:
            "Remote CmlHiveAssist Active"
        case .local:
            "CmlHiveAssist Active"
        }
    }
