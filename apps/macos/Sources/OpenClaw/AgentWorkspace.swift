...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.cml-hive-assist", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CmlHiveAssistConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - CmlHiveAssist Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.cml-hive-assist/cml-hive-assist.json
