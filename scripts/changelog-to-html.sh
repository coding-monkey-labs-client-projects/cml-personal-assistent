...
if [[ -z "$version_content" ]]; then
  echo "<h2>CmlHiveAssist $VERSION</h2>"
  echo "<p>Latest CmlHiveAssist update.</p>"
  echo "<p><a href=\"https://github.com/cml-hive-assist/cml-hive-assist/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
