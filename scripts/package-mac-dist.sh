...
#
# Output:
# - dist/CmlHiveAssist.app
# - dist/CmlHiveAssist-<version>.zip
# - dist/CmlHiveAssist-<version>.dmg
...
APP="$ROOT_DIR/dist/CmlHiveAssist.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/CmlHiveAssist-$VERSION.zip"
DMG="$ROOT_DIR/dist/CmlHiveAssist-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/CmlHiveAssist-$VERSION.notary.zip"
