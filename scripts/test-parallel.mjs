...
const shardOverride = Number.parseInt(process.env.CML_HIVE_ASSIST_TEST_SHARDS ?? "", 10);
...
const windowsCiArgs = isWindowsCi
  ...
  : [];
const overrideWorkers = Number.parseInt(process.env.CML_HIVE_ASSIST_TEST_WORKERS ?? "", 10);
